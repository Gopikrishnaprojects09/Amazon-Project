...
WebUI.setText(findTestObject('Amazon_button001/Page_Amazon Sign In/input_Email or mobile phone number_email'), Email)

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Amazon_button001/Page_Amazon Sign In/input_Forgot Password_password'), '0KgSb6dmQkDO+DyTs7S1JA==')
